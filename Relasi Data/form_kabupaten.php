...
<table width="100%" border="0">
  <tr>
    ...
    <td><input type="text" name="nama_kabupaten" size="30"/></td>
  </tr>
  <tr>
    <td width="200">Ibukota Kabupaten</td>
    <td><input type="text" name="ibukota_kabupaten" size="40"/></td>
  </tr>
  <tr>
    <td width="200">Luas Wilayah</td>
    <td><input type="text" name="luas_wilayah" size="20"/></td>
  </tr>
  <tr>
