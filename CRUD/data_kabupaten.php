...
while ($data = mysqli_fetch_array($hasil)){
  ...
  echo"<td align='center' id='td'><a href =form_ubah_kabupaten.php?id=$data[id_kabupaten]'>Ubah</a></td>\n";
  echo"<td align='center' id='td'><a href =hapus_kabupaten.php?id=$data[id_kabupaten]' onclick=\"return confirm('Apakah anda yakin menghapus data?')\">Hapus</a></td>\n";
  echo"</tr>\n";
}
// =========================================================//
echo"</table>\n";
